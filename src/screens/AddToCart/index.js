...
import {Container,Header,Title,Content,Button,Icon,Left,Body,Right,SwipeRow,Text} from "native-base";
...
class Cart extends React.Component < Props, State > {
  ...
  onSecureCheckout(){
     ...
     this.state.cartItems.map((res, key)=>{
       console.log("res..........",res)
       listArray.push({product_id:res.id,flavour_id:res.flavour_id,size_id:res.size_id,totalQuantity:res.totalQuantity,price:res.price})
     })
