...
//New Design
import TrainersProfile from "./screens/TrainersProfile";

import RatingScreen from "./screens/rating";

import CalenderScreen from "./screens/Calender";

import FreeLiveGroupScreen from "./screens/FreeliveGroup";
...
const AppNavigator = StackNavigator(
  {
    ...
    CalenderScreen : { screen : CalenderScreen },

    FreeLiveGroupScreen : { screen : FreeLiveGroupScreen },


    NHCard : { screen : NHCard },

    TrainersProfile : { screen : TrainersProfile },
