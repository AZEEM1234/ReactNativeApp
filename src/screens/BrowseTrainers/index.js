...
render() {
        ...
        <View style={styles.headerStyle}></View>
            <Header style={styles.headerStyle}>
                ...
                <Image
                    ...
                    resizeMode="cover"
                />
                <Title style={styles.title}>Browse Trainers</Title>
            ...
            <Card rounded style={{borderRadius: 44 / 2,width:350, top: 160,left:30,shadowColor: "#000",
                        shadowOffset: {
                            width: 0,
                            height: 2,
                        },
    ...
    borderBottomWidth: 1,position:'absolute',
                            ...
                            overflow:'visible',
                        borderColor:"#000"}}>
                            <InputGroup searchBar rounded style={{backgroundColor: '#fff',borderRadius: 44 / 2,width:350,borderColor:"#000",}}>
                                <Icon name='ios-search' />
                                <TextInput placeholder='Search by Trainer name' placeholderTextColor="grey"
                                           style={{color: '#000',left:70,width:170}}/>
                                <Icon name='ios-people' style={{left: 100}}/>
                            </InputGroup>
                            </Card>
